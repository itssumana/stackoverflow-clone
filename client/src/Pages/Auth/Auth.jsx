...
import './Auth.css'
import icon from '../../assets/stackoverflow-icon.png'
    ...
    return (
        <section className='auth-section'>
            ...
            <div className='auth-container-2'>
                { !isSignup && <img className='icon-img' src={icon} alt='stackoverflow icon'/>}
                ...
                { isSignup && 
                    <div style={{ color: "#666767", fontSize:"13px", marginTop: "10px"}}>
